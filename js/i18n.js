...
(function () {
  ...
  const DICT = {
    ...
    'sc1.li3':   { de: 'Logbuch in einem Tap — Tageswert je Gewohnheit per Stepper oder Slider', en: 'Logbook in one tap — each habit’s value via stepper or slider', es: 'Logbook en un toque — el valor de cada hábito con stepper o slider', fr: "Logbook en un tap — la valeur de chaque habitude au stepper ou au slider", it: 'Logbook con un tap — il valore di ogni abitudine con stepper o slider' },
