...
(function () {
  ...
  const DICT = {
    ...
    'hero.altRef':   { de: 'Reflect — Lebensrad', en: 'Reflect — Wheel of Life', es: 'Reflect — Rueda de la vida', fr: 'Reflect — Roue de la vie', it: 'Reflect — Ruota della vita' },
    ...
    'arc1.area': { de: 'Wachstum', en: 'Growth', es: 'Crecimiento', fr: 'Croissance', it: 'Crescita' },
    'arc1.dur':  { de: '2 Wochen', en: '2 weeks', es: '2 semanas', fr: '2 semaines', it: '2 settimane' },
    'arc1.h':    { de: 'Bestandsaufnahme', en: 'Baseline', es: 'Punto de partida', fr: 'Point de départ', it: 'Punto di partenza' },
    ...
    'arc1.h1':   { de: 'Schritte ≥ 8.000', en: 'Steps ≥ 8,000', es: 'Pasos ≥ 8.000', fr: 'Pas ≥ 8 000', it: 'Passi ≥ 8.000' },
    'arc1.h2':   { de: 'Schlaf ≥ 7 h', en: 'Sleep ≥ 7 h', es: 'Sueño ≥ 7 h', fr: 'Sommeil ≥ 7 h', it: 'Sonno ≥ 7 h' },
    'arc1.h3':   { de: 'Wasser ≥ 2 l', en: 'Water ≥ 2 l', es: 'Agua ≥ 2 l', fr: 'Eau ≥ 2 l', it: 'Acqua ≥ 2 l' },
    'arc1.h4':   { de: 'Bildschirmzeit ≤ 3 h', en: 'Screen time ≤ 3 h', es: 'Tiempo de pantalla ≤ 3 h', fr: 'Temps d’écran ≤ 3 h', it: 'Tempo schermo ≤ 3 h' },
    'arc1.h5':   { de: 'Stimmung notieren · 1×/Tag', en: 'Log your mood · 1×/day', es: 'Anotar el ánimo · 1×/día', fr: 'Noter l’humeur · 1×/jour', it: 'Annota l’umore · 1×/giorno' },

    // ARC 2 — Sleep First (Body, 3 weeks) — from supabase seed_arcs_basic
    'arc2.area': { de: 'Körper', en: 'Body', es: 'Cuerpo', fr: 'Corps', it: 'Corpo' },
    'arc2.dur':  { de: '3 Wochen', en: '3 weeks', es: '3 semanas', fr: '3 semaines', it: '3 settimane' },
    'arc2.h':    { de: 'Schlaf zuerst', en: 'Sleep First', es: 'Dormir primero', fr: "Le sommeil d'abord", it: 'Prima il sonno' },
    ...
    'arc2.h1':   { de: 'Schlaf ≥ 7,5 h', en: 'Sleep ≥ 7.5 h', es: 'Sueño ≥ 7,5 h', fr: 'Sommeil ≥ 7,5 h', it: 'Sonno ≥ 7,5 h' },
    'arc2.h2':   { de: 'Feste Aufstehzeit', en: 'Consistent wake time', es: 'Hora de despertar constante', fr: 'Heure de réveil constante', it: 'Orario di sveglia costante' },
    'arc2.h3':   { de: 'Keine Bildschirme 1 h vor dem Bett', en: 'No screens 1 h before bed', es: 'Sin pantallas 1 h antes de dormir', fr: 'Pas d’écran 1 h avant le coucher', it: 'Niente schermi 1 h prima di dormire' },
    'arc2.h4':   { de: 'Kein Koffein nach 14 Uhr', en: 'No caffeine after 2 pm', es: 'Sin cafeína después de las 14 h', fr: 'Pas de caféine après 14 h', it: 'Niente caffeina dopo le 14' },
    'arc2.h5':   { de: 'Tageslicht ≥ 10 min · morgens', en: 'Daylight ≥ 10 min · morning', es: 'Luz natural ≥ 10 min · por la mañana', fr: 'Lumière du jour ≥ 10 min · matin', it: 'Luce naturale ≥ 10 min · mattina' },

    // ARC 3 — Quiet Mind (Mind, 3 weeks) — from supabase seed_arcs_basic
    'arc3.area': { de: 'Geist', en: 'Mind', es: 'Mente', fr: 'Esprit', it: 'Mente' },
    'arc3.dur':  { de: '3 Wochen', en: '3 weeks', es: '3 semanas', fr: '3 semaines', it: '3 settimane' },
    'arc3.h':    { de: 'Ruhiger Geist', en: 'Quiet Mind', es: 'Mente en calma', fr: 'Esprit calme', it: 'Mente serena' },
    ...
    'arc3.h1':   { de: 'Meditation · 10 min', en: 'Meditation · 10 min', es: 'Meditación · 10 min', fr: 'Méditation · 10 min', it: 'Meditazione · 10 min' },
    'arc3.h2':   { de: 'Atemübung · 5 min', en: 'Breathing exercise · 5 min', es: 'Ejercicio de respiración · 5 min', fr: 'Exercice de respiration · 5 min', it: 'Esercizio di respirazione · 5 min' },
    'arc3.h3':   { de: 'Dankbarkeit · 3 Dinge/Tag', en: 'Gratitude · 3 things/day', es: 'Gratitud · 3 cosas/día', fr: 'Gratitude · 3 choses/jour', it: 'Gratitudine · 3 cose/giorno' },
    'arc3.h4':   { de: 'Zeit in der Natur ≥ 20 min', en: 'Time in nature ≥ 20 min', es: 'Tiempo en la naturaleza ≥ 20 min', fr: 'Temps dans la nature ≥ 20 min', it: 'Tempo nella natura ≥ 20 min' },
    'arc3.h5':   { de: 'Handyfreie Stunde', en: 'Phone-free hour', es: 'Hora sin móvil', fr: 'Heure sans téléphone', it: 'Ora senza telefono' },
    ...
    'sc4.alt': { de: 'Reflect — Lebensrad-Radar mit Bewertung 37 von 50 über fünf Lebensbereiche', en: 'Reflect — Wheel-of-Life radar showing 37 out of 50 across five life areas', es: 'Reflect — radar Rueda de la vida con 37 de 50 en cinco áreas', fr: "Reflect — radar Roue de la vie à 37 sur 50 sur cinq domaines", it: 'Reflect — radar Ruota della vita con 37 su 50 sulle cinque aree' },
    ...
    'a1.d': { de: 'Ausdauer, Kraft, Beweglichkeit, Schlaf, Ernährung, Erholung.', en: 'Endurance, strength, mobility, sleep, nutrition, recovery.', es: 'Resistencia, fuerza, movilidad, sueño, nutrición, recuperación.', fr: 'Endurance, force, mobilité, sommeil, nutrition, récupération.', it: 'Resistenza, forza, mobilità, sonno, nutrizione, recupero.' },
    ...
    'faq04.q': { de: 'Was sind die fünf Lebensbereiche?', en: 'What are the five life areas?', es: '¿Cuáles son las cinco áreas de vida?', fr: 'Quels sont les cinq domaines de vie ?', it: 'Quali sono le cinque aree di vita?' },
    'faq04.a': {
      de: 'ArcUp arbeitet mit genau fünf Lebensbereichen:<ul><li><strong>Körper</strong> – Sport, Schlaf, Ernährung, Erholung</li><li><strong>Geist</strong> – Meditation, Achtsamkeit, Stress-Regulation</li><li><strong>Wachstum</strong> – Lernen, Lesen, Karriere, Ziele</li><li><strong>Beziehungen</strong> – gemeinsame Zeit, aktives Zuhören, Familienrituale</li><li><strong>Freizeit</strong> – Hobbys, Naturzeit, kreative Aktivitäten</li></ul>Du bewertest jeden Bereich regelmäßig auf einer Skala von 1–10 (Lebensrad), schreibst eine persönliche Vision dazu und siehst auf einen Blick, wo gerade die Balance fehlt.',
      ...
      es: 'ArcUp trabaja con exactamente cinco áreas de vida:<ul><li><strong>Cuerpo</strong> — deporte, sueño, nutrición, recuperación</li><li><strong>Mente</strong> — meditación, atención plena, regulación del estrés</li><li><strong>Crecimiento</strong> — aprendizaje, lectura, carrera, metas</li><li><strong>Relaciones</strong> — tiempo de calidad, escucha activa, rituales familiares</li><li><strong>Ocio</strong> — aficiones, naturaleza, actividades creativas</li></ul>Puntúas cada área regularmente del 1 al 10 (Rueda de la vida), escribes una visión personal y ves de un vistazo dónde falta equilibrio.',
      fr: "ArcUp s'appuie sur exactement cinq domaines de vie :<ul><li><strong>Corps</strong> — sport, sommeil, nutrition, récupération</li><li><strong>Esprit</strong> — méditation, pleine conscience, gestion du stress</li><li><strong>Croissance</strong> — apprentissage, lecture, carrière, objectifs</li><li><strong>Relations</strong> — temps de qualité, écoute active, rituels familiaux</li><li><strong>Loisirs</strong> — passe-temps, nature, activités créatives</li></ul>Tu notes chaque domaine régulièrement de 1 à 10 (Roue de la vie), tu écris une vision personnelle et tu vois d'un coup d'œil où l'équilibre manque.",
      it: 'ArcUp lavora con esattamente cinque aree di vita:<ul><li><strong>Corpo</strong> — sport, sonno, nutrizione, recupero</li><li><strong>Mente</strong> — meditazione, mindfulness, regolazione dello stress</li><li><strong>Crescita</strong> — apprendimento, lettura, carriera, obiettivi</li><li><strong>Relazioni</strong> — tempo di qualità, ascolto attivo, rituali familiari</li><li><strong>Tempo libero</strong> — hobby, natura, attività creative</li></ul>Valuti ogni area regolarmente da 1 a 10 (Ruota della vita), scrivi una visione personale e vedi a colpo d’occhio dove manca equilibrio.',
    },
    ...
    'faq12.a': {
      ...
      es: 'Toca el botón <strong>+ Registrar</strong> en la pantalla Home para abrir tu logbook. Ahí registras el valor de hoy para cada hábito activo — con selector numérico o control deslizante. También hay un <strong>timer</strong> (cronómetro o Pomodoro) para hábitos basados en tiempo.',
      fr: "Touche le bouton <strong>+ Saisir</strong> sur l'écran d'accueil pour ouvrir ton logbook. Tu y saisis la valeur du jour pour chaque habitude active — via sélecteur numérique ou curseur. Il y a aussi un <strong>timer</strong> (chrono ou Pomodoro) pour les habitudes basées sur le temps, à faire tourner en direct.",
      it: 'Tocca il pulsante <strong>+ Registra</strong> nella Home per aprire il tuo logbook. Lì inserisci il valore di oggi per ogni abitudine attiva — con selettore numerico o cursore. C’è anche un <strong>timer</strong> (cronometro o Pomodoro) per abitudini basate sul tempo, da far girare live.',
    },
    ...
    'faq22.a': {
      de: 'Der <strong>Free-Tarif</strong> umfasst:<ul><li>Tracking aller Gewohnheiten aus der ausgewählten Sammlung</li><li>Einen aktiven ARC gleichzeitig</li><li>Lebensbereiche mit Lebensrad und Vision-Texten</li><li>Zugriff auf die Lerninhalte</li><li>Selbstbewertung (regelmäßige Updates pro Lebensbereich)</li></ul>',
      en: 'The <strong>Free plan</strong> includes:<ul><li>Tracking of all habits from the selected library</li><li>One active ARC at a time</li><li>Life areas with Wheel of Life and vision texts</li><li>Access to Learning Content</li><li>Self-assessments (rating updates per life area)</li></ul>',
      es: 'El plan <strong>Free</strong> incluye:<ul><li>Tracking de todos los hábitos de la biblioteca seleccionada</li><li>Un ARC activo a la vez</li><li>Áreas de vida con Rueda de la vida y textos de visión</li><li>Acceso a los contenidos de aprendizaje</li><li>Autoevaluaciones (actualizar puntuación por área)</li></ul>',
      fr: "Le plan <strong>Free</strong> comprend :<ul><li>Le suivi de toutes les habitudes de la bibliothèque sélectionnée</li><li>Un ARC actif à la fois</li><li>Les domaines de vie avec Roue de la vie et textes de vision</li><li>L'accès aux contenus d'apprentissage</li><li>Les auto-évaluations (mise à jour des notes par domaine de vie)</li></ul>",
    ...
    'faq28.a': {
      de: 'Mit Pro siehst du drei Bereiche:<ul><li><strong>Gewohnheiten-Tab</strong> – Erfüllungs-Heatmap, Werteverlauf, Streaks und automatisch mitgezählte Untergewohnheiten pro Gewohnheit</li><li><strong>ARCs-Tab</strong> – Erfolgsrate, durchschnittliche Erfüllung, Verteilung auf Lebensbereiche über alle ARCs</li><li><strong>Gesamt-Tab</strong> – dein 90-Tage-Profil mit perfekten Tagen, aktiver Zeit, Lebensbalance und Top-Gewohnheiten</li></ul>Alle Zahlen entstehen aus deinen echten Logs – keine geschönten Statistiken.',
      en: 'With Pro you see three areas:<ul><li><strong>Habits tab</strong> — completion heatmap, value history, streaks and automatically aggregated sub-habits per habit</li><li><strong>ARCs tab</strong> — success rate, average completion, life-area distribution across all ARCs</li><li><strong>Overall tab</strong> — your 90-day profile with perfect days, active time, life balance and top habits</li></ul>All numbers come from your real logs — no embellished stats.',
      es: 'Con Pro ves tres áreas:<ul><li><strong>Pestaña Hábitos</strong> — heatmap de cumplimiento, evolución, rachas y subhábitos agregados automáticamente por hábito</li><li><strong>Pestaña ARCs</strong> — tasa de éxito, cumplimiento medio, distribución por life area</li><li><strong>Pestaña General</strong> — tu perfil de 90 días con días perfectos, tiempo activo, life balance y top hábitos</li></ul>Todos los números vienen de tus logs reales — sin estadísticas maquilladas.',
      fr: "Avec Pro tu vois trois zones :<ul><li><strong>Onglet Habitudes</strong> — heatmap de complétion, historique, séries et sous-habitudes agrégées automatiquement par habitude</li><li><strong>Onglet ARCs</strong> — taux de succès, complétion moyenne, répartition par life area</li><li><strong>Onglet Général</strong> — ton profil 90 jours avec jours parfaits, temps actif, life balance et top habitudes</li></ul>Tous les chiffres viennent de tes logs réels — pas de stats embellies.",
      it: 'Con Pro vedi tre aree:<ul><li><strong>Tab Abitudini</strong> — heatmap di completamento, andamento, streak e sotto-abitudini sommate automaticamente per ogni abitudine</li><li><strong>Tab ARCs</strong> — tasso di successo, completamento medio, distribuzione per life area</li><li><strong>Tab Generale</strong> — il tuo profilo 90 giorni con giorni perfetti, tempo attivo, life balance e top abitudini</li></ul>Tutti i numeri vengono dai tuoi log reali — niente statistiche abbellite.',
    },
    ...
    'faq35.a': {
      de: 'Ja. Im Profil unter <strong>„Meine Daten exportieren"</strong> bekommst du ein <strong>vollständiges ZIP-Archiv</strong> aller deiner Daten – Gewohnheiten, ARCs, Logs, Ziele, Tagebuch-Einträge und Cover-Bilder. Aus Performance-Gründen ist der Export auf einmal pro 24 Stunden begrenzt.',
    ...
    'faq38.a': {
      de: 'Nein. Inhalte vom Typ „ArcUp Original" werden <strong>vorab und redaktionell</strong> mit KI-Unterstützung erstellt – ohne Bezug zu individuellen Nutzerprofilen. Wenn du den KI-ARC-Generator nutzt, geht <strong>ausschließlich dein eingetippter Prompt</strong> an Anthropic – keine App-Daten, keine personenbezogenen Informationen.',
      en: 'No. "ArcUp Original" content is created <strong>in advance and editorially</strong> with AI support — independent of individual user profiles. When you use the AI ARC Generator, <strong>only your typed prompt</strong> is sent to Anthropic — no app data, no personal information.',
      es: 'No. Los contenidos «ArcUp Original» se crean <strong>de antemano y de forma editorial</strong> con apoyo de IA — sin relación con perfiles de usuario individuales. Cuando usas el Generador IA de ARCs, <strong>solo tu prompt</strong> se envía a Anthropic — sin datos de la app, sin información personal.',
      fr: "Non. Les contenus « ArcUp Original » sont créés <strong>en amont et de manière éditoriale</strong> avec assistance IA — indépendamment des profils utilisateurs individuels. Quand tu utilises le Générateur IA d'ARCs, <strong>seul ton prompt</strong> est envoyé à Anthropic — pas de données app, pas d'informations personnelles.",
      it: 'No. I contenuti «ArcUp Original» sono creati <strong>in anticipo e in modo editoriale</strong> con supporto IA — indipendentemente dai profili utente. Quando usi il Generatore IA di ARC, <strong>solo il tuo prompt</strong> viene inviato ad Anthropic — nessun dato dell’app, nessuna informazione personale.',
    },
