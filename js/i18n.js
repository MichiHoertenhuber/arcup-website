...
(function () {
  ...
  const DICT = {
    ...
    'sc3.h':   { de: 'Die Quellen hinter dem System.', en: 'The sources behind the system.', es: 'Las fuentes detrás del sistema.', fr: 'Les sources derrière le système.', it: 'Le fonti dietro al sistema.' },
    'sc3.b':   { de: 'Hinter jedem ARC steht ein Buch, eine Studie, ein Talk. Sechs Quellentypen — als 5- bis 10-minütige Destillate lesbar, direkt mit Habits und ARCs verlinkt.', en: 'Behind every ARC sits a book, a study, a talk. Six source types — readable as 5- to 10-minute distillations, linked directly to habits and ARCs.', es: 'Detrás de cada ARC hay un libro, un estudio, una charla. Seis tipos de fuentes — destilados de 5–10 minutos, vinculados a hábitos y ARCs.', fr: "Derrière chaque ARC : un livre, une étude, une conférence. Six types de sources — distillés de 5 à 10 minutes, liés aux habitudes et ARC.", it: 'Dietro a ogni ARC c’è un libro, uno studio, un talk. Sei tipi di fonti — leggibili come distillati di 5–10 minuti, collegati ad abitudini e ARC.' },
    'sc3.li1': { de: 'Buch · Artikel · Film · Creator · Rede · ArcUp Original', en: 'Book · Article · Film · Creator · Speech · ArcUp Original', es: 'Libro · Artículo · Película · Creador · Discurso · ArcUp Original', fr: 'Livre · Article · Film · Créateur · Discours · ArcUp Original', it: 'Libro · Articolo · Film · Creator · Discorso · ArcUp Original' },
    'sc3.li2': { de: 'Kein „im Buch lernst du…" — die Kernideen direkt destilliert, 4–8 Minuten Lesedauer', en: 'No "you’ll learn in the book…" — core ideas distilled directly, 4–8 minutes to read', es: 'Nada de «en el libro aprenderás…» — ideas centrales destiladas, 4–8 minutos de lectura', fr: "Pas de « vous apprendrez dans le livre » — les idées clés distillées, 4–8 min de lecture", it: 'Niente «nel libro imparerai…» — idee chiave distillate, 4–8 minuti di lettura' },
    'sc3.li3': { de: 'Jede Quelle ist mit den ARCs und Habits verknüpft, die sie inspiriert hat', en: 'Each source is linked to the ARCs and habits it inspired', es: 'Cada fuente está vinculada a los ARCs y hábitos que inspiró', fr: "Chaque source est liée aux ARC et habitudes qu'elle a inspirés", it: 'Ogni fonte è collegata agli ARC e alle abitudini che ha ispirato' },
    'sc3.alt': { de: 'Discover — Quellen-Bibliothek mit Atomic Habits, 168 Hours und Can’t Hurt Me', en: 'Discover — source library with Atomic Habits, 168 Hours and Can’t Hurt Me', es: 'Discover — biblioteca de fuentes con Atomic Habits, 168 Hours y Can’t Hurt Me', fr: "Discover — bibliothèque de sources avec Atomic Habits, 168 Hours et Can't Hurt Me", it: 'Discover — biblioteca di fonti con Atomic Habits, 168 Hours e Can’t Hurt Me' },
    ...
    'a1.h': { de: 'Body', en: 'Body', es: 'Body', fr: 'Body', it: 'Body' },
    ...
    'a2.h': { de: 'Mind', en: 'Mind', es: 'Mind', fr: 'Mind', it: 'Mind' },
    ...
    'a3.h': { de: 'Growth', en: 'Growth', es: 'Growth', fr: 'Growth', it: 'Growth' },
    ...
    'a4.h': { de: 'Relationships', en: 'Relationships', es: 'Relationships', fr: 'Relationships', it: 'Relationships' },
    ...
    'a5.h': { de: 'Leisure', en: 'Leisure', es: 'Leisure', fr: 'Leisure', it: 'Leisure' },
    ...
    // ─── FOUNDATION ──────────────────────────────────────
    'fnd1.over': { de: 'Quellen-fundiert', en: 'Source-grounded', es: 'Basado en fuentes', fr: 'Sourcé', it: 'Basato sulle fonti' },
    'fnd1.h':    { de: 'Jede Empfehlung hat eine Quelle.', en: 'Every recommendation has a source.', es: 'Cada recomendación tiene una fuente.', fr: 'Chaque recommandation a une source.', it: 'Ogni raccomandazione ha una fonte.' },
    'fnd1.b':    { de: 'Sechs Quellentypen, mikro-konsumierbar in 4 bis 8 Minuten lesbar. Direkt aus der App. Mit Habits und ARCs verknüpft.', en: 'Six source types, readable in 4 to 8 minutes. Directly from the app. Linked to habits and ARCs.', es: 'Seis tipos de fuentes, legibles en 4 a 8 minutos. Directo desde la app. Vinculadas a hábitos y ARCs.', fr: "Six types de sources, lisibles en 4 à 8 minutes. Directement dans l'app. Liés aux habitudes et ARC.", it: 'Sei tipi di fonti, leggibili in 4–8 minuti. Direttamente nell’app. Collegate ad abitudini e ARC.' },
    ...
    'pr.sub':  { de: 'Alle Kernfunktionen sind frei. Pro schaltet die Tiefe frei — Personal ARC, mehrere parallele ARCs, Insights, Journal, Ziele, KI-Generator.', en: 'All core features are free. Pro unlocks the depth — Personal ARC, multiple parallel ARCs, Insights, Journal, Goals, AI generator.', es: 'Las funciones esenciales son gratis. Pro desbloquea la profundidad — Personal ARC, varios ARCs en paralelo, Insights, Diario, Metas, generador IA.', fr: "Toutes les fonctions essentielles sont gratuites. Pro débloque la profondeur — Personal ARC, plusieurs ARC en parallèle, Insights, Journal, Objectifs, générateur IA.", it: "Tutte le funzioni principali sono gratis. Pro sblocca la profondità — Personal ARC, più ARC in parallelo, Insights, Diario, Obiettivi, generatore IA." },
    ...
    'pr.free.l5':    { de: 'Personal ARC (endlos, Pro)', en: 'Personal ARC (endless, Pro)', es: 'Personal ARC (sin fin, Pro)', fr: 'Personal ARC (sans fin, Pro)', it: 'Personal ARC (senza fine, Pro)' },
    ...
    'pr.lt.l2':     { de: '<strong>Personal ARC</strong> — die einzige ARC ohne Enddatum', en: '<strong>Personal ARC</strong> — the only ARC without an end date', es: '<strong>Personal ARC</strong> — el único ARC sin fecha de fin', fr: '<strong>Personal ARC</strong> — le seul ARC sans date de fin', it: '<strong>Personal ARC</strong> — l’unico ARC senza data di fine' },
    ...
    'faq3.a': { de: 'Drei Quellen: <strong>kuratiert</strong> vom ArcUp-Team auf Basis von Büchern, Reden und Forschung, <strong>selbst erstellt</strong> per Drei-Schritte-Wizard (Pro) oder <strong>KI-generiert</strong> aus einem natürlichsprachigen Prompt (Pro).', en: 'Three sources: <strong>curated</strong> by the ArcUp team based on books, talks and research, <strong>self-made</strong> via a three-step wizard (Pro), or <strong>AI-generated</strong> from a natural-language prompt (Pro).', es: 'Tres fuentes: <strong>curados</strong> por el equipo ArcUp a partir de libros, charlas e investigación, <strong>creados por ti</strong> con un asistente de tres pasos (Pro), o <strong>generados por IA</strong> desde un prompt natural (Pro).', fr: "Trois sources : <strong>sélectionnés</strong> par l’équipe ArcUp à partir de livres, conférences et recherches, <strong>créés par vous</strong> via un assistant en trois étapes (Pro), ou <strong>générés par IA</strong> à partir d'un prompt en langage naturel (Pro).", it: 'Tre fonti: <strong>curati</strong> dal team ArcUp da libri, talk e ricerca, <strong>creati da te</strong> tramite procedura guidata in tre passi (Pro), o <strong>generati dall’IA</strong> da un prompt in linguaggio naturale (Pro).' },
