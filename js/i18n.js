...
(function () {
  ...
  const DICT = {
    ...
    'sc2.alt': { de: 'ARCademy — ARCs und Gewohnheiten in einem Tab, mit Suche und Filter', en: 'ARCademy — ARCs and habits in one tab, with search and filter', es: 'ARCademy — ARCs y hábitos en una pestaña, con búsqueda y filtros', fr: 'ARCademy — ARC et habitudes dans un onglet, avec recherche et filtres', it: 'ARCademy — ARC e abitudini in un tab, con ricerca e filtri' },

    // 03 Insights (App-Screenshot folgt — Platzhalter: ARC-Bild)
    ...
    'sc3.alt': { de: 'Insights — Auswertungen aus deinen echten Logs (App-Screenshot folgt)', en: 'Insights — analysis from your real logs (app screenshot coming soon)', es: 'Insights — análisis desde tus registros reales (captura de la app en camino)', fr: "Insights — analyses depuis tes vrais logs (capture de l'app à venir)", it: 'Insights — analisi dai tuoi log reali (screenshot dell’app in arrivo)' },
