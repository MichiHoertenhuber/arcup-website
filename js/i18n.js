...
(function () {
  ...
  const DICT = {
    ...
    'p2.h': { de: 'Anfang und Ende statt Endlos.', en: 'A finish line, not a forever streak.', es: 'Principio y final, no sin fin.', fr: 'Un début et une fin, pas sans fin.', it: 'Un inizio e una fine, non all’infinito.' }, // _x:'Befristet statt endlos.', en: 'Time-boxed, not endless.', es: 'Con plazo, no sin fin.', fr: 'Limité dans le temps, pas sans fin.', it: 'A tempo, non infinito.' },
    'p2.b': {
      de: 'Echte Verhaltensänderung passiert in fokussierten Phasen mit einem Ziel vor Augen. Ein ARC läuft 1 bis 12 Wochen — mit Commitment am Start und einem echten Abschluss am Ende, statt einem Streak, der nur darauf wartet zu reißen.',
      en: 'Real behaviour change happens in focused phases with a finish in sight. An ARC runs 1 to 12 weeks — a commitment at the start and a real finish at the end, instead of a streak that is only waiting to break.',
      es: 'El cambio real ocurre en fases enfocadas con una meta a la vista. Un ARC dura de 1 a 12 semanas — con compromiso al inicio y un cierre real al final, en lugar de una racha que solo espera para romperse.',
      fr: "Le vrai changement arrive par phases focalisées, avec une fin en vue. Un ARC dure de 1 à 12 semaines — un engagement au départ et une vraie fin à l'arrivée, au lieu d'une série qui n'attend que de se rompre.",
      it: 'Il vero cambiamento avviene per fasi focalizzate, con un traguardo in vista. Un ARC dura da 1 a 12 settimane — un impegno all’inizio e una vera conclusione alla fine, invece di una serie che aspetta solo di rompersi.',
    },
