...
(function () {
  ...
  const DICT = {
    ...
    'faq28.a': {
      de: 'ArcUp zeigt dir drei Bereiche:<ul><li><strong>Gesamt-Tab</strong> – dein 90-Tage-Profil mit perfekten Tagen, aktiver Zeit, Lebensbalance und Top-Gewohnheiten <em>(kostenlos)</em></li><li><strong>ARCs-Tab</strong> – Erfolgsrate, durchschnittliche Erfüllung und Verteilung auf Lebensbereiche über alle ARCs <em>(kostenlos)</em></li><li><strong>Gewohnheiten-Tab</strong> – Erfüllungs-Heatmap, Werteverlauf, Streaks, automatisch mitgezählte Untergewohnheiten und Habit-Korrelationen pro Gewohnheit <em>(Pro)</em></li></ul>Alle Zahlen entstehen aus deinen echten Logs – keine geschönten Statistiken.',
