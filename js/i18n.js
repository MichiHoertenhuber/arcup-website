...
(function () {
  ...
  const DICT = {
    ...
    'faq24.a': {
      de: 'Stand bei Vertragserstellung der AGB:<ul><li><strong>Pro Monat</strong> – € 6,99 (monatliche automatische Verlängerung)</li><li><strong>Pro Jahr</strong> – € 49,99 (jährliche Verlängerung, bester Preis)</li></ul>Die jeweils aktuellen Preise findest du in der App im Bildschirm „Abonnement".',
      en: 'As of the date the terms were drafted:<ul><li><strong>Pro Monthly</strong> — € 6.99 (auto-renews monthly)</li><li><strong>Pro Yearly</strong> — € 49.99 (annual renewal, best price)</li></ul>The current prices are shown in the app on the "Subscription" screen.',
      es: 'A fecha de redacción de los términos:<ul><li><strong>Pro Mensual</strong> — € 6,99 (renovación mensual automática)</li><li><strong>Pro Anual</strong> — € 49,99 (renovación anual, mejor precio)</li></ul>Los precios actuales aparecen en la app, pantalla «Suscripción».',
      fr: "À la date de rédaction des CGU :<ul><li><strong>Pro Mensuel</strong> — € 6,99 (renouvellement mensuel automatique)</li><li><strong>Pro Annuel</strong> — € 49,99 (renouvellement annuel, meilleur prix)</li></ul>Les prix actuels sont visibles dans l'app, écran « Abonnement ».",
      it: 'Alla data di stesura delle Condizioni:<ul><li><strong>Pro Mensile</strong> — € 6,99 (rinnovo mensile automatico)</li><li><strong>Pro Annuale</strong> — € 49,99 (rinnovo annuale, miglior prezzo)</li></ul>I prezzi correnti sono nell’app, schermata «Abbonamento».',
    },
