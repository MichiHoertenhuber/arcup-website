...
(function () {
  ...
  const DICT = {
    ...
    'faq23.a': {
      ...
      en: 'With <strong>Pro</strong> you unlock:<ul><li>Multiple parallel ARCs</li><li>Self-made ARCs (wizard) and habits</li><li><strong>AI ARC generator</strong> — from one sentence the AI builds a complete ARC for you</li><li>Goal tracking and journaling</li><li>Insights with heatmaps, trends, correlations and 90-day profiles</li><li>Premium Learning Content</li></ul>',
    ...
    'faq24.a': {
      de: 'Stand bei Vertragserstellung der AGB:<ul><li><strong>Pro Monat</strong> – € 6,99 (monatliche automatische Verlängerung)</li><li><strong>Pro Jahr</strong> – € 49,99 (jährliche Verlängerung, bester Preis)</li><li><strong>Pro Lifetime</strong> – € 149,99 einmalig, unbegrenzt</li></ul>Die jeweils aktuellen Preise findest du in der App im Bildschirm „Abonnement".',
      ...
      es: 'A fecha de redacción de los términos:<ul><li><strong>Pro Mensual</strong> — € 6,99 (renovación mensual automática)</li><li><strong>Pro Anual</strong> — € 49,99 (renovación anual, mejor precio)</li><li><strong>Pro Lifetime</strong> — € 149,99 pago único, ilimitado</li></ul>Los precios actuales aparecen en la app, pantalla «Suscripción».',
      fr: "À la date de rédaction des CGU :<ul><li><strong>Pro Mensuel</strong> — € 6,99 (renouvellement mensuel automatique)</li><li><strong>Pro Annuel</strong> — € 49,99 (renouvellement annuel, meilleur prix)</li><li><strong>Pro Lifetime</strong> — € 149,99 paiement unique, illimité</li></ul>Les prix actuels sont visibles dans l'app, écran « Abonnement ».",
      it: 'Alla data di stesura delle Condizioni:<ul><li><strong>Pro Mensile</strong> — € 6,99 (rinnovo mensile automatico)</li><li><strong>Pro Annuale</strong> — € 49,99 (rinnovo annuale, miglior prezzo)</li><li><strong>Pro Lifetime</strong> — € 149,99 una tantum, illimitato</li></ul>I prezzi correnti sono nell’app, schermata «Abbonamento».',
    },
