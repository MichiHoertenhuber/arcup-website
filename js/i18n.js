...
(function () {
  ...
  const DICT = {
    ...
    // 03 Discover
    'sc3.num': { de: '03 — Discover · Quellen', en: '03 — Discover · Sources', es: '03 — Discover · Fuentes', fr: '03 — Discover · Sources', it: '03 — Discover · Fonti' },
    ...
    'sc3.b':   { de: 'Discover hat zwei Tabs — Quellen und Gewohnheiten. Im Quellen-Tab steht hinter jedem Gewohnheit und jedem ARC ein redaktionelles Briefing: selbst geschrieben, in 4 bis 8 Minuten lesbar, direkt verknüpft.', en: 'Discover has two tabs — Sources and Habits. In the Sources tab, every habit and ARC is backed by an editorial briefing: written by us, readable in 4 to 8 minutes, directly linked.', es: 'Discover tiene dos pestañas — Fuentes y Hábitos. En Fuentes, detrás de cada hábito y cada ARC hay un briefing editorial: escrito por nosotros, legible en 4 a 8 minutos, directamente vinculado.', fr: "Discover a deux onglets — Sources et Habitudes. Dans Sources, chaque habitude et chaque ARC est appuyé par un briefing éditorial : écrit par nous, lisible en 4 à 8 minutes, directement lié.", it: 'Discover ha due tab — Fonti e Abitudini. Nel tab Fonti, dietro ogni abitudine e ogni ARC c’è un briefing editoriale: scritto da noi, leggibile in 4–8 minuti, collegato direttamente.' },
    ...
    'sc3b.num': { de: '03 — Discover · Gewohnheiten', en: '03 — Discover · Habits', es: '03 — Discover · Habits', fr: '03 — Discover · Habits', it: '03 — Discover · Habits' },
    ...
    'pf.contentLibrary': { de: 'Quellen',      en: 'Sources &amp; Content Library', es: 'Fuentes y Biblioteca',       fr: 'Sources &amp; Bibliothèque',  it: 'Fonti &amp; Biblioteca' },
    ...
    'faq.intro': {
      de: 'Antworten auf die Fragen, die uns am häufigsten zu Gewohnheiten, ARCs, der Quellen, Pricing und Datenschutz gestellt werden.',
    ...
    'faqs.library':    { de: 'Quellen', en: 'Library &amp; sources', es: 'Biblioteca y fuentes', fr: 'Bibliothèque et sources', it: 'Biblioteca e fonti' },
    ...
    'faq01.a': {
      de: 'ArcUp ist eine mobile App für <strong>strukturierte persönliche Entwicklung</strong>. Sie verbindet drei Zeit-Ebenen miteinander:<ul><li><strong>Lebensbereiche</strong> – langfristig: fünf Bereiche mit Vision, Zielen und Journal (<em>Wer will ich werden?</em>)</li><li><strong>ARCs</strong> – mittelfristig: zeitlich begrenzte Challenges über 1 bis 12 Wochen (<em>Was übe ich gerade gezielt?</em>)</li><li><strong>Gewohnheiten</strong> – täglich: numerisch messbare Gewohnheiten (<em>Was tue ich heute konkret?</em>)</li></ul>Unsere Tagline: <em>ArcUp – Building Better Gewohnheiten.</em>',
    ...
    'faq02.q': { de: 'Ist ArcUp ein klassischer Gewohnheits-Tracker?', en: 'Is ArcUp a classic habit tracker?', es: '¿ArcUp es un habit tracker clásico?', fr: 'ArcUp est-il un habit tracker classique ?', it: 'ArcUp è un habit tracker classico?' },
    'faq02.a': {
    ...
    'faq06.q': { de: 'Wie unterscheiden sich Gewohnheiten, ARCs und Goals?', en: 'What is the difference between habits, ARCs and goals?', es: '¿En qué se diferencian hábitos, ARCs y goals?', fr: 'Quelle est la différence entre habitudes, ARC et goals ?', it: 'Qual è la differenza tra abitudini, ARC e goal?' },
    'faq06.a': {
      de: '<ul><li><strong>Gewohnheiten</strong> sind die atomaren, messbaren Einheiten – z. B. „Laufen in km".</li><li><strong>ARCs</strong> bündeln Gewohnheiten zu einer zeitlich begrenzten Challenge mit konkreten Zielwerten.</li><li><strong>Goals</strong> sind separate, einmalige Vorhaben mit Fälligkeitsdatum („Bis Ende Mai 5 km am Stück laufen") und gehören zum jeweiligen Lebensbereich.</li></ul>Goals sind Aufgaben mit Deadline. Gewohnheiten sind die Messskala, auf der dein Verhalten sichtbar wird.',
    ...
    'faq19.q': { de: 'Was sind ARC-Sources / die Quellen?', en: 'What are ARC-Sources / the Learning Library?', es: '¿Qué son las ARC-Sources / la biblioteca de aprendizaje?', fr: 'Qu’est-ce que les ARC-Sources / la bibliothèque ?', it: 'Cosa sono le ARC-Sources / la biblioteca?' },
    'faq19.a': {
      de: 'Jeder ARC und jede Gewohnheit baut auf einer <strong>Wissensgrundlage</strong> auf – Büchern, Artikeln, Vorträgen oder eigens für ArcUp redaktionell aufbereiteten Beiträgen („ArcUp Originals"). In der Quellen kannst du diese Quellen direkt in der App lesen, durchsuchen, filtern und als Favoriten speichern. Du siehst zu jeder Quelle, welche ARCs und Gewohnheiten darauf aufbauen.',
    ...
    'faq21.q': { de: 'Was sind die Affiliate-Links bei den Quellen?', en: 'What are the affiliate links in the library?', es: '¿Qué son los enlaces de afiliado en la biblioteca?', fr: 'Que sont les liens affiliés dans la bibliothèque ?', it: 'Cosa sono i link affiliati nella biblioteca?' },
    'faq21.a': {
    ...
    'faq22.a': {
      de: 'Der <strong>Free-Tarif</strong> umfasst:<ul><li>Tracking aller Gewohnheiten aus der kuratierten Sammlung</li><li>Einen aktiven ARC gleichzeitig</li><li>Lebensbereiche mit Wheel of Life und Vision-Texten</li><li>Zugriff auf die Quellen</li><li>Selbstbewertung (regelmäßige Updates pro Lebensbereich)</li></ul>',
    ...
    'faq35.a': {
      de: 'Ja. Im Profil unter <strong>„Export My Data"</strong> bekommst du ein <strong>vollständiges ZIP-Archiv</strong> aller deiner Daten – Gewohnheiten, ARCs, Logs, Goals, Journal-Einträge und Cover-Bilder. Aus Performance-Gründen ist der Export auf einmal pro 24 Stunden begrenzt.',
    ...
    'faq40.a': {
      de: 'In der App findest du unter „Feedback" ein direktes Eingabeformular für Bugs, Feature-Wünsche oder Vorschläge für neue ARCs, Gewohnheiten und Quellen. Jede Nachricht landet direkt im Inbox der Entwicklung – wir lesen alles.',
