...
(function () {
  ...
  const DICT = {
    ...
    'hero.altARCs':  { de: 'ARCademy — ausgewählte ARCs', en: 'ARCademy — curated ARCs', es: 'ARCademy — ARCs curados', fr: 'ARCademy — ARC sélectionnés', it: 'ARCademy — ARC selezionati' },
    ...
    'sc3b.li1': { de: 'Über 120 ausgewählte Gewohnheiten in einer Baum-Struktur — durchsuchbar und filterbar', en: 'Over 120 curated habits in a tree structure — searchable and filterable', es: 'Más de 120 hábitos curados en estructura de árbol — buscables y filtrables', fr: "Plus de 120 habitudes sélectionnées dans une arborescence — recherchables et filtrables", it: 'Oltre 120 abitudini curate in una struttura ad albero — ricercabili e filtrabili' },
