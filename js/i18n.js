...
(function () {
  ...
  const DICT = {
    ...
    'sc2.h':   { de: 'Deine ARCs — und jede Gewohnheit dahinter.', en: 'Your ARCs — and every habit behind them.', es: 'Tus ARCs — y cada hábito que hay detrás.', fr: 'Tes ARC — et chaque habitude derrière.', it: 'I tuoi ARC — e ogni abitudine che c’è dietro.' },
    ...
    'sc4.h':   { de: 'Das Warum hinter jeder Gewohnheit.', en: 'The why behind every habit.', es: 'El porqué detrás de cada hábito.', fr: 'Le pourquoi derrière chaque habitude.', it: 'Il perché dietro ogni abitudine.' },
    ...
    'sc5.h':   { de: 'Dein Leben auf einem Rad.', en: 'Your life on a single wheel.', es: 'Tu vida en una sola rueda.', fr: 'Ta vie sur une seule roue.', it: 'La tua vita su una sola ruota.' },
